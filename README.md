...
o	Verifica que la estructura esté igual a la descrita arriba.
4.	Ramas y Pull Requests
o	Cada miembro crea su rama para las tareas asignadas: 
o	git checkout -b [nombre_usuario]_rutas
o	Al terminar cambios: 
o	git add .
o	git commit -m "Creación de tabla Rutas"
o	git push origin [nombre_usuario]_rutas
o	Crear un Pull Request en GitHub para integrar los cambios a la rama principal.
