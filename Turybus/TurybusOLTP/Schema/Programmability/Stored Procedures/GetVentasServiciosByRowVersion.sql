...
BEGIN
    SELECT
        ...
        sd.id_autobus,
        sd.id_conductor,
        sd.hora_salida AS HoraSalida,
        sd.hora_llegada AS HoraLlegada,
    ...
    GROUP BY 
        b.id_billete, sd.id_servicio, b.fecha, 
        sd.id_ruta, sd.id_autobus, sd.id_conductor,
        sd.hora_salida, sd.hora_llegada, sd.dias_operacion,
        b.id_pasajero, b.id_empleado, pa.id_parada
END
GO