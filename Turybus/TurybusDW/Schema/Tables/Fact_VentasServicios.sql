CREATE TABLE Fact_VentasServicios (
    ...
    DateKey_billete INT NOT NULL,                           -- Reemplaza FechaServicio y referencia a Dim_Calendar
    ...
    FOREIGN KEY (DateKey_billete) REFERENCES Dim_Calendar(DateKey)  -- Relación con Dim_Calendar
);
