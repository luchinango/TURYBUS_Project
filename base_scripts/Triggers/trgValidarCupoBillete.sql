...
SELECT @id_autobus = id_autobus FROM Turismo.ServiciosDiarios WHERE id_servicio = @id_servicio;
SELECT @plazas = plazas FROM Operaciones.Autobuses WHERE id_autobus = @id_autobus;
